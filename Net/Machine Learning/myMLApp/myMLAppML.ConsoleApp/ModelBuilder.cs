...
namespace MyMLAppML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\..\GitHub\AI\Net\Machine Learning\myMLApp\data\wikipedia-detox-250-line-data.tsv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 5E-07f, ConvergenceTolerance = 0.01f, NumberOfIterations = 20, Shuffle = false, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
